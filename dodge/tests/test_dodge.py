...
class TestDodge_full(unittest.TestCase):
    ...
    def test_with_dummy_week_investigation(self):
        ...
        expected_investclusters = cwd+"/expected_outputs/fulltest1_expected_investigation_clusters.txt"
    ...
    def test_with_dummy_month_investigation(self):
        ...
        expected_investclusters = cwd+"/expected_outputs/fulltest2_expected_investigation_clusters.txt"
